...
set val(rxpower) 35.28e-3			
set val(txpower) 31.32e-3			
...
#open topology file
set topo_file [open 802154topo.txt w]
...
$ns at 200 "finish"
$ns  at 201 "$ns nam-end-wireless 200.00"
$ns at 202 "$ns halt"
